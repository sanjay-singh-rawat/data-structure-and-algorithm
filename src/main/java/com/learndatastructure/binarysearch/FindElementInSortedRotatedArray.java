...
public class FindElementInSortedRotatedArray {
    ...
    public static void main(String[] args) {
        ...
        Assertions.assertTrue(searchInSingleIteration(new int[] {11, 12, 15, 18, 2, 5, 6, 8}, 12));
        Assertions.assertFalse(searchInSingleIteration(new int[] {11, 12, 15, 18, 2, 5, 6, 8}, 1));
    }
    ...
    private static boolean searchInSingleIteration(int[] arr, int target) {
        int start = 0;
