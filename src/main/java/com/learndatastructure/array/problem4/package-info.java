...
/**
 * Count the number of occurrences of each element. Find the element with maximum occurrences and subtract that number of occurrences from the initial array size
 * to determine the minimum number of elements that must be deleted. The total complexity for this is O(n).
 */